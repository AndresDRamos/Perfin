...
| auth | docs/modules/auth.md; docs/architecture/adr/006-supabase-auth-username-login.md; docs/database/data-dictionary.md | docs/plans/* (history) | Touches the `profile` table, the username↔email resolution, or session validation (`getSessionUser`/`requireSessionUser`)? |
